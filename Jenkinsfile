                ...
                stage("Build & test a static Linux ppc64el binary") {
                    ...
                    agent {
                        dockerfile {
                            ...
                            dir '.'
                            label 'linux && triqs'
                            args '--platform=linux/ppc64le --group-add=987 --group-add=980 --group-add=988 --entrypoint=\'\''
                ...
                stage("Build & test a static Linux arm64 binary") {
                    ...
                    agent {
                        dockerfile {
                            ...
                            dir '.'
                            label 'linux && triqs'
                            args '--platform=linux/arm64 --group-add=987 --group-add=980 --group-add=988 --entrypoint=\'\''
