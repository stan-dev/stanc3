  $ $TESTDIR/..//../../_build/default/stanc.exe --auto-format "$TESTDIR/..//stat_comp_benchmarks_models/sir.stan"
  functions {
    real[] simple_SIR(real t, real[] y, real[] theta, real[] x_r, int[] x_i) {
      real dydt[4];
  ...
  model {
    ...
    for (n in 2 : N_t) stoi_hat[n] ~ poisson(y[n - 1, 1] - y[n, 1]);
