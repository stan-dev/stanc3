...
namespace eight_schools_locscale_naive_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "stan/src/test/test-models/good/stat_comp_benchmarks_models/eight_schools_locscale_naive.stan");
    reader.add_event(20, 18, "end", "stan/src/test/test-models/good/stat_comp_benchmarks_models/eight_schools_locscale_naive.stan");
    return reader;
}

class eight_schools_locscale_naive_model : public prob_grad {
private:
        int J;
        std::vector<double> y;
        std::vector<double> sigma;
public:
    eight_schools_locscale_naive_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "eight_schools_locscale_naive_model_namespace::eight_schools_locscale_naive_model";
    ...
    ~eight_schools_locscale_naive_model() { }
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        for (size_t i_0__ = 0; i_0__ < theta_i_0_max__; ++i_0__) {
            try {
                writer__.scalar_locscale_unconstrain(0, 1, theta[i_0__]);
            } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (size_t d_0__ = 0; d_0__ < theta_d_0_max__; ++d_0__) {
                if (jacobian__)
                    theta.push_back(in__.scalar_locscale_constrain(0, 1, lp__));
                else
                    theta.push_back(in__.scalar_locscale_constrain(0, 1));
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "eight_schools_locscale_naive_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "eight_schools_locscale_naive_model";
    }
...
typedef eight_schools_locscale_naive_model_namespace::eight_schools_locscale_naive_model stan_model;
