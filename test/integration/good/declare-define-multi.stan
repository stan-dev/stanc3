data {
  int a0, a1, a2;
  real[5] b0, b1, b3;
  vector[5][3,2] c0, c1, c2, c4;
  matrix[5,4][3,2] d0, d1;
}
transformed data {
  int td_a0=0, td_a1 = 2;
  int td_a2, td_a3;
  ...
  real[2] td_d0 = {-1.5, -2.5}, td_d1 = {1.5, 2.5};
  real[2] td_d2, td_d3;
  real[2] td_d4 = {-1.5, -2.5}, td_d5, td_d6 = {1.5, 2.5};

  {
    ...
    real[2] loc_d0 = {-1.5, -2.5}, loc_d1 = {1.5, 2.5};
    real[2] loc_d2, loc_d3;
    real[2] loc_d4 = {-1.5, -2.5}, loc_d5, loc_d6 = {1.5, 2.5};
  }
}
parameters {
  real[5] par_b0, par_b1, par_b3;
  vector[5][3,2] par_c0, par_c1, par_c2, par_c4;
  matrix[5,4][3,2] par_d0, par_d1;
}
transformed parameters {
  ...
  real[2] tpar_d0 = {-1.5, -2.5}, tpar_d1 = {1.5, 2.5};
  real[2] tpar_d2, tpar_d3;
  real[2] tpar_d4 = {-1.5, -2.5}, tpar_d5, tpar_d6 = {1.5, 2.5};

  {
    ...
    real[2] loc_tpar_d0 = {-1.5, -2.5}, loc_tpar_d1 = {1.5, 2.5};
    real[2] loc_tpar_d2, loc_tpar_d3;
    real[2] loc_tpar_d4 = {-1.5, -2.5}, loc_tpar_d5, loc_tpar_d6 = {1.5, 2.5};
  }
}
...
model {
  ...
  real[2] model_d0 = {-1.5, -2.5}, model_d1 = {1.5, 2.5};
  real[2] model_d2, model_d3;
  real[2] model_d4 = {-1.5, -2.5}, model_d5, model_d6 = {1.5, 2.5};

  {
    ...
    real[2] loc_model_d0 = {-1.5, -2.5}, loc_model_d1 = {1.5, 2.5};
    real[2] loc_model_d2, loc_model_d3;
    real[2] loc_model_d4 = {-1.5, -2.5}, loc_model_d5, loc_model_d6 = {1.5, 2.5};
  }
...
generated quantities {
  ...
  real[2] gq_d0 = {-1.5, -2.5}, gq_d1 = {1.5, 2.5};
  real[2] gq_d2, gq_d3;
  real[2] gq_d4 = {-1.5, -2.5}, gq_d5, gq_d6 = {1.5, 2.5};

  {
    ...
    real[2] loc_gq_d0 = {-1.5, -2.5}, loc_gq_d1 = {1.5, 2.5};
    real[2] loc_gq_d2, loc_gq_d3;
    real[2] loc_gq_d4 = {-1.5, -2.5}, loc_gq_d5, loc_gq_d6 = {1.5, 2.5};
  }
}