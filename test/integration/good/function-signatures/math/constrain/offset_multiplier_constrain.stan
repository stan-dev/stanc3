...
transformed parameters {
  real transformed_param_real;
   ...
   transformed_param_real = offset_multiplier_constrain(d_real, e_real, f_real);
   ...
   transformed_param_real = offset_multiplier_constrain(p_real, e_real, p_real);
   ...
   transformed_param_real = offset_multiplier_constrain(d_real, e_real, p_real);
