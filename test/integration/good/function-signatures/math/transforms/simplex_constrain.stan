...
transformed data {
  ...
  td_vector = simplex_constrain(d_vector);
  td_vector_array_1d = simplex_constrain(d_vector_array_1d);
  td_vector_array_2d = simplex_constrain(d_vector_array_2d);
  td_vector_array_3d = simplex_constrain(d_vector_array_3d);
}
...
transformed parameters {
  ...
  transformed_param_vector_array_1d = simplex_constrain(d_vector_array_1d);
  transformed_param_vector_array_1d = simplex_constrain(p_vector_array_1d);
  transformed_param_vector_array_2d = simplex_constrain(d_vector_array_2d);
  transformed_param_vector_array_2d = simplex_constrain(p_vector_array_2d);
  transformed_param_vector_array_3d = simplex_constrain(d_vector_array_3d);
  transformed_param_vector_array_3d = simplex_constrain(p_vector_array_3d);
}
