...
transformed data {
  ...
  td_matrix = corr_matrix_constrain(d_vector, d_int);
  td_matrix_array_1d = corr_matrix_constrain(d_vector_array_1d, d_int);
  td_matrix_array_2d = corr_matrix_constrain(d_vector_array_2d, d_int);
  td_matrix_array_3d = corr_matrix_constrain(d_vector_array_3d, d_int);
}
...
transformed parameters {
  ...
  transformed_param_matrix_array_1d = corr_matrix_constrain(d_vector_array_1d, d_int);
  transformed_param_matrix_array_1d = corr_matrix_constrain(p_vector_array_1d, d_int);
  transformed_param_matrix_array_2d = corr_matrix_constrain(d_vector_array_2d, d_int);
  transformed_param_matrix_array_2d = corr_matrix_constrain(p_vector_array_2d, d_int);
  transformed_param_matrix_array_3d = corr_matrix_constrain(d_vector_array_3d, d_int);
  transformed_param_matrix_array_3d = corr_matrix_constrain(p_vector_array_3d, d_int);
}
