...
transformed data {
  ...
  td_vector = cholesky_factor_corr_unconstrain(d_matrix);
  td_vector_array_1d = cholesky_factor_corr_unconstrain(d_matrix_array_1d);
  td_vector_array_2d = cholesky_factor_corr_unconstrain(d_matrix_array_2d);
  td_vector_array_3d = cholesky_factor_corr_unconstrain(d_matrix_array_3d);
}
...
transformed parameters {
  ...
  transformed_param_vector = cholesky_factor_corr_unconstrain(d_matrix);
  transformed_param_vector = cholesky_factor_corr_unconstrain(p_matrix);
  transformed_param_vector_array_1d = cholesky_factor_corr_unconstrain(d_matrix_array_1d);
  transformed_param_vector_array_1d = cholesky_factor_corr_unconstrain(p_matrix_array_1d);
  transformed_param_vector_array_2d = cholesky_factor_corr_unconstrain(d_matrix_array_2d);
  transformed_param_vector_array_2d = cholesky_factor_corr_unconstrain(p_matrix_array_2d);
  transformed_param_vector_array_3d = cholesky_factor_corr_unconstrain(d_matrix_array_3d);
  transformed_param_vector_array_3d = cholesky_factor_corr_unconstrain(p_matrix_array_3d);
}
