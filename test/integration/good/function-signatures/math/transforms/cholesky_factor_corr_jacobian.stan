...
transformed parameters {
  ...
  transformed_param_matrix = cholesky_factor_corr_jacobian(d_vector, d_int);
  transformed_param_matrix = cholesky_factor_corr_jacobian(p_vector, d_int);
  transformed_param_matrix_array_1d = cholesky_factor_corr_jacobian(d_vector_array_1d, d_int);
  transformed_param_matrix_array_1d = cholesky_factor_corr_jacobian(p_vector_array_1d, d_int);
  transformed_param_matrix_array_2d = cholesky_factor_corr_jacobian(d_vector_array_2d, d_int);
  transformed_param_matrix_array_2d = cholesky_factor_corr_jacobian(p_vector_array_2d, d_int);
  transformed_param_matrix_array_3d = cholesky_factor_corr_jacobian(d_vector_array_3d, d_int);
  transformed_param_matrix_array_3d = cholesky_factor_corr_jacobian(p_vector_array_3d, d_int);
}
