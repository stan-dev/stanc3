...
transformed data {
  ...
  td_vector = ordered_constrain(d_vector);
  td_vector_array_1d = ordered_constrain(d_vector_array_1d);
  td_vector_array_2d = ordered_constrain(d_vector_array_2d);
  td_vector_array_3d = ordered_constrain(d_vector_array_3d);
}
...
transformed parameters {
  ...
  transformed_param_vector_array_1d = ordered_constrain(d_vector_array_1d);
  transformed_param_vector_array_1d = ordered_constrain(p_vector_array_1d);
