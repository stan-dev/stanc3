...
transformed data {
  ...
  transformed_data_matrix = inv_inc_beta(d_matrix);
  transformed_data_vector = inv_inc_beta(d_vector);
  transformed_data_row_vector = inv_inc_beta(d_row_vector);
  trans_x3y = inv_inc_beta(x3y);
  trans_x4y = inv_inc_beta(x4y);
  trans_x5y = inv_inc_beta(x5y);
  
  trans_x2z = inv_inc_beta(x1z);
  trans_x2z = inv_inc_beta(x2z);
  trans_x3z = inv_inc_beta(x3z);
  trans_x4z = inv_inc_beta(x4z);
  trans_x5z = inv_inc_beta(x5z);
  
  trans_x2w = inv_inc_beta(x1w);
  trans_x2w = inv_inc_beta(x2w);
  trans_x3w = inv_inc_beta(x3w);
  trans_x4w = inv_inc_beta(x4w);
  trans_x5w = inv_inc_beta(x5w);
}
parameters {
  real p_real;
  real y_p;
...
transformed parameters {
  ...
  transformed_param_matrix = inv_inc_beta(d_matrix);
  transformed_param_vector = inv_inc_beta(d_vector);
  transformed_param_row_vector = inv_inc_beta(d_row_vector);
  transformed_param_matrix = inv_inc_beta(p_matrix);
  transformed_param_vector = inv_inc_beta(p_vector);
  transformed_param_row_vector = inv_inc_beta(p_row_vector);
  
  trans_p_x3y = inv_inc_beta(p_x3y);
  trans_p_x4y = inv_inc_beta(p_x4y);
  trans_p_x5y = inv_inc_beta(p_x5y);
  
  trans_p_x2z = inv_inc_beta(p_x2z);
  trans_p_x3z = inv_inc_beta(p_x3z);
  trans_p_x4z = inv_inc_beta(p_x4z);
  trans_p_x5z = inv_inc_beta(p_x5z);
  
  trans_p_x2w = inv_inc_beta(p_x2w);
  trans_p_x3w = inv_inc_beta(p_x3w);
  trans_p_x4w = inv_inc_beta(p_x4w);
  trans_p_x5w = inv_inc_beta(p_x5w);
}
model {
  y_p ~ normal(0, 1);
}
