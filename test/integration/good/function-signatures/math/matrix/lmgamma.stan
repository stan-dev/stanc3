...
transformed data {
  ...
  transformed_data_vector_array_3d = lmgamma(d_int_array_4d, d_vector_array_3d);
  ...
  transformed_data_row_vector_array = lmgamma(d_int_array_2d, d_row_vector_array);
  transformed_data_row_vector_array_2d = lmgamma(d_int, d_row_vector_array_2d);
  transformed_data_row_vector_array_2d = lmgamma(d_int_array_3d, d_row_vector_array_2d);
  transformed_data_row_vector_array_3d = lmgamma(d_int, d_row_vector_array_3d);
  transformed_data_row_vector_array_3d = lmgamma(d_int_array_4d, d_row_vector_array_3d);
  ...
  transformed_data_matrix_array_2d = lmgamma(d_int_array_4d, d_matrix_array_2d);
  transformed_data_matrix_array_3d = lmgamma(d_int, d_matrix_array_3d);
  transformed_data_matrix_array_3d = lmgamma(d_int_array_5d, d_matrix_array_3d);
...
transformed parameters {
  ...
  transformed_param_real_array = lmgamma(d_int_array, transformed_param_real_array);
  transformed_param_real_array_2d = lmgamma(d_int_array_2d, transformed_param_real);
  transformed_param_real_array_2d = lmgamma(d_int_array_2d, transformed_param_real_array_2d);
  transformed_param_real_array_3d = lmgamma(d_int_array_3d, transformed_param_real);
  transformed_param_real_array_3d = lmgamma(d_int_array_3d, transformed_param_real_array_3d);

  transformed_param_real_array = lmgamma(d_int, transformed_param_real_array);
  transformed_param_real_array_2d = lmgamma(d_int, transformed_param_real_array_2d);
  transformed_param_real_array_3d = lmgamma(d_int, transformed_param_real_array_3d);
  ...
  transformed_param_vector_array = lmgamma(d_int, transformed_param_vector_array);
  transformed_param_vector_array = lmgamma(d_int_array_2d, transformed_param_vector_array);
  transformed_param_vector_array_2d = lmgamma(d_int, transformed_param_vector_array_2d);
  transformed_param_vector_array_2d = lmgamma(d_int_array_3d, transformed_param_vector_array_2d);
  transformed_param_vector_array_3d = lmgamma(d_int, transformed_param_vector_array_3d);
  transformed_param_vector_array_3d = lmgamma(d_int_array_4d, transformed_param_vector_array_3d);

  transformed_param_row_vector = lmgamma(d_int, transformed_param_row_vector);
  transformed_param_row_vector = lmgamma(d_int_array, transformed_param_row_vector);
  transformed_param_row_vector_array = lmgamma(d_int, transformed_param_row_vector_array);
  transformed_param_row_vector_array = lmgamma(d_int_array_2d, transformed_param_row_vector_array);
  transformed_param_row_vector_array_2d = lmgamma(d_int, transformed_param_row_vector_array_2d);
  transformed_param_row_vector_array_2d = lmgamma(d_int_array_3d, transformed_param_row_vector_array_2d);
  transformed_param_row_vector_array_3d = lmgamma(d_int, transformed_param_row_vector_array_3d);
  transformed_param_row_vector_array_3d = lmgamma(d_int_array_4d, transformed_param_row_vector_array_3d);

  transformed_param_matrix = lmgamma(d_int, transformed_param_matrix);
  transformed_param_matrix = lmgamma(d_int_array_2d, transformed_param_matrix);
  transformed_param_matrix_array = lmgamma(d_int, transformed_param_matrix_array);
  transformed_param_matrix_array = lmgamma(d_int_array_3d, transformed_param_matrix_array);
  transformed_param_matrix_array_2d = lmgamma(d_int, transformed_param_matrix_array_2d);
  transformed_param_matrix_array_2d = lmgamma(d_int_array_4d, transformed_param_matrix_array_2d);
  transformed_param_matrix_array_3d = lmgamma(d_int, transformed_param_matrix_array_3d);
  transformed_param_matrix_array_3d = lmgamma(d_int_array_5d, transformed_param_matrix_array_3d);
}
model {  
  y_p ~ normal(0,1);
}
