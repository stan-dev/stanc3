data {
  ...
  positive_ordered[9][11] h3;
  positive_ordered[9][12,13] h4;

  corr_matrix[10] j;
  corr_matrix[10] j1[3];
  corr_matrix[10] j2[5,6];
  corr_matrix[10][3] j3;
  corr_matrix[10][5,6] j4;

  cov_matrix[10] k;
  cov_matrix[10] k1[3];
  cov_matrix[10] k2[5,6];
  cov_matrix[10][3] k3;
  cov_matrix[10][5,6] k4;
}
transformed data {
  int td_a0;
  int td_a1[1];
...

  {
    ...
    vector[7][8] loc_td_c3;
    vector[7][8,9] loc_td_c4;

    row_vector[7] loc_td_d0;
    row_vector[7] loc_td_d1[8];
    row_vector[7] loc_td_d2[8,9];
    row_vector[7][8] loc_td_d3;
    row_vector[7][8,9] loc_td_d4;

    matrix[8,9] loc_td_e;
    matrix[8,9] loc_td_e1[11];
    matrix[8,9] loc_td_e2[11,12];
    matrix[8,9][11] loc_td_e3;
    matrix[8,9][11,12] loc_td_e4;
  }
}
parameters {
  real par_b0;
  ...
  row_vector[7][8] par_d3;
  row_vector[7][8,9] par_d4;

  matrix[8,9] par_e;
  matrix[8,9] par_e1[11];
  matrix[8,9] par_e2[11,12];
  matrix[8,9][11] par_e3;
  matrix[8,9][11,12] par_e4;

  simplex[8] par_f;
  simplex[8] par_f1[9];
  simplex[8] par_f2[9,10];
  simplex[8][9] par_f3;
  simplex[8][9,10] par_f4;
  
  ordered[9] par_g;
  ordered[9] par_g1[11];
  ordered[9] par_g2[12,13];
  ordered[9][11] par_g3;
  ordered[9][12,13] par_g4;

  positive_ordered[9] par_h;
  positive_ordered[9] par_h1[11];
  positive_ordered[9] par_h2[12,13];
  positive_ordered[9][11] par_h3;
  positive_ordered[9][12,13] par_h4;

  corr_matrix[10] par_j;
  corr_matrix[10] par_j1[3];
  corr_matrix[10] par_j2[5,6];
  corr_matrix[10][3] par_j3;
  corr_matrix[10][5,6] par_j4;

  cov_matrix[10] par_k;
  cov_matrix[10] par_k1[3];
  cov_matrix[10] par_k2[5,6];
  cov_matrix[10][3] par_k3;
  cov_matrix[10][5,6] par_k4;
}
...
generated quantities {
  ...
  row_vector[7][8] gq_d3;
  row_vector[7][8,9] gq_d4;

  matrix[8,9] gq_e;
  matrix[8,9] gq_e1[11];
  matrix[8,9] gq_e2[11,12];
  matrix[8,9][11] gq_e3;
  matrix[8,9][11,12] gq_e4;

  simplex[8] gq_f;
  simplex[8] gq_f1[9];
  simplex[8] gq_f2[9,10];
  simplex[8][9] gq_f3;
  simplex[8][9,10] gq_f4;
  
  ordered[9] gq_g;
  ordered[9] gq_g1[11];
  ordered[9] gq_g2[12,13];
  ordered[9][11] gq_g3;
  ordered[9][12,13] gq_g4;

  positive_ordered[9] gq_h;
  positive_ordered[9] gq_h1[11];
  positive_ordered[9] gq_h2[12,13];
  positive_ordered[9][11] gq_h3;
  positive_ordered[9][12,13] gq_h4;

  corr_matrix[10] gq_j;
  corr_matrix[10] gq_j1[3];
  corr_matrix[10] gq_j2[5,6];
  corr_matrix[10][3] gq_j3;
  corr_matrix[10][5,6] gq_j4;

  cov_matrix[10] gq_k;
  cov_matrix[10] gq_k1[3];
  cov_matrix[10] gq_k2[5,6];
  cov_matrix[10][3] gq_k3;
  cov_matrix[10][5,6] gq_k4;

  {
    ...
    vector[7][8] loc_gq_c3;
    vector[7][8,9] loc_gq_c4;

    row_vector[7] loc_gq_d0;
    row_vector[7] loc_gq_d1[8];
    row_vector[7] loc_gq_d2[8,9];
    row_vector[7][8] loc_gq_d3;
    row_vector[7][8,9] loc_gq_d4;

    matrix[8,9] loc_gq_e;
    matrix[8,9] loc_gq_e1[11];
    matrix[8,9] loc_gq_e2[11,12];
    matrix[8,9][11] loc_gq_e3;
    matrix[8,9][11,12] loc_gq_e4;
  }
}
