functions {
  ...
  tuple(array[] int, array[] int, real, array[] int, real, real, real, real,
        real, real, real) vote_countvote_countvote_countvote_count2(array[] int rating,
                                                                    array[] int item,
                                                                    array[] int rater,
                                                                    int I,
                                                                    int J) {
    ...
    return (count, item, 3.14, rater, 2.71, 1, 1, 1, 1, 1, 1);
  }
}
