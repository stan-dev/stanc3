...
let%expect_test "udf" =
  ...
  [%expect
    ...
    template <typename T0__, typename T1__,
              ...
              stan::require_not_complex_t<stan::value_type_t<T0__>>* = nullptr,
              stan::require_row_vector_t<T1__>* = nullptr,
              stan::require_not_complex_t<stan::value_type_t<T1__>>* = nullptr>
    void
...
let%expect_test "udf-expressions" =
  ...
  [%expect
    ...
    template <typename T0__, typename T1__, typename T2__, typename T3__,
              ...
              stan::require_not_complex_t<stan::value_type_t<T2__>>* = nullptr,
