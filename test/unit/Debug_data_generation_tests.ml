...
let%expect_test "Tuples program" =
  ...
  [%expect
    {|
      {
        "d": [ 4.1815278199399577, 5 ],
        "complicated": [
          [ 4.6316923208946168, 3.612729318255341 ],
          5,
          [
        ...
        "n": [ 5.8799711085519224, [ 4.521098476935741, 2.2826025797056464 ] ],
        "nested": [
          [ 2.6451502425447266, [ [ 5, 4 ], [ 5, 6 ], [ 3, 6 ], [ 6, 3 ] ] ],
          [ 3.9660375311552749, [ [ 2, 3 ], [ 3, 2 ], [ 5, 5 ], [ 2, 6 ] ] ],
          [ 5.3116509882058738, [ [ 5, 2 ], [ 4, 5 ], [ 4, 6 ], [ 2, 5 ] ] ]
        ]
      } |}]
