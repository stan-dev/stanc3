...
let%expect_test "evaluate a repeated scalar argument once" =
  let mir =
    reset_and_mir_of_string
      {|
      functions {
...
let%expect_test "evaluate repeated integer and complex arguments once" =
  let mir =
    reset_and_mir_of_string
      {|
      functions {
...
let%expect_test "preserve scalar argument evaluation order" =
  let mir =
    reset_and_mir_of_string
      {|
      functions {
...
let%expect_test "bind repeated scalar arguments for void functions" =
  let mir =
    reset_and_mir_of_string
      {|
...
let%expect_test "evaluate a repeated scalar argument before branching" =
  let mir =
    reset_and_mir_of_string
      {|
      functions {
  ...
  [%expect
    ...
    real theta;
    {
      real inline_piecewise_x_arg_sym1__;
      real inline_piecewise_return_sym2__;
      inline_piecewise_x_arg_sym1__ = exp(theta);
      data int inline_piecewise_early_ret_check_sym3__;
      inline_piecewise_early_ret_check_sym3__ = 0;
      for(inline_piecewise_iterator_sym4__ in 1:1) {
        if((inline_piecewise_x_arg_sym1__ > 0)) {
          inline_piecewise_early_ret_check_sym3__ = 1;
          inline_piecewise_return_sym2__ = (inline_piecewise_x_arg_sym1__ * inline_piecewise_x_arg_sym1__);
          break;
        }
        inline_piecewise_early_ret_check_sym3__ = 1;
        inline_piecewise_return_sym2__ = PMinus__(inline_piecewise_x_arg_sym1__);
        break;
      }
      target += inline_piecewise_return_sym2__;
    }
    |}]
