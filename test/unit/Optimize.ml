      ...
      (((fdrt ()) (fdname f) (fdsuffix FnPure)
        ...
        (fdbody
         (((pattern
           ...
           (meta <opaque>))))
        (fdloc <opaque>))
       ((fdrt (UReal)) (fdname g) (fdsuffix FnPure)
         ...
         (Block
          (((pattern
           ...
           ((pattern
             (IfElse
              ((pattern
                (FunApp (StanLib Greater__ FnPure)
                 (((pattern (Lit Int 1))
                   (meta ((type_ UInt) (loc <opaque>) (adlevel DataOnly))))
                  ((pattern (Lit Int 2))
                   (meta ((type_ UInt) (loc <opaque>) (adlevel DataOnly)))))))
