...
((functions_block
  (((fdrt Void) (fdname f) (fdsuffix FnPlain)
   ...
   ((fdrt (ReturnType UReal)) (fdname g) (fdsuffix FnPlain)
    (fdargs ((AutoDiffable z UInt))) (fdannotation ())
    (fdbody
     (((pattern
        (Block
         (((pattern
      ...
      (((pattern
       ...
       ((pattern
         (Decl (decl_adtype AutoDiffable) (decl_id inline_g_return_sym2__)
          (decl_type (Sized SReal)) (decl_annotation ()) (initialize false)))
        (meta <opaque>))
       ((pattern
         (Block
          (((pattern
    ...
    {|
      (((pattern
         (Decl (decl_adtype AutoDiffable) (decl_id w) (decl_type (Sized SReal))
          (decl_annotation ()) (initialize true)))
        (meta <opaque>))
       ((pattern
         (Block
          (((pattern
           ...
           ((pattern
             (Decl (decl_adtype DataOnly) (decl_id z_data)
              (decl_type (Sized SReal)) (decl_annotation ()) (initialize true)))
            (meta <opaque>))
           ((pattern
             (IfElse
              ((pattern
