...
let _ =
  ...
  add_plain ("assign_multiply", Void, [Matrix; Int]) ;
  add_plain ("assign_multiply", Void, [Real; Int]) ;
  add_plain ("assign_multiply", Void, [RowVector; Int]) ;
  add_plain ("assign_multiply", Void, [RowVector; Matrix]) ;
  add_plain ("assign_multiply", Void, [Vector; Real]) ;
  add_plain ("assign_multiply", Void, [Vector; Int]) ;
  ...
  add_plain ("assign_add", Void, [Matrix; Int]) ;
  add_plain ("assign_add", Void, [Real; Int]) ;
  add_plain ("assign_add", Void, [RowVector; Int]) ;
  add_plain ("assign_add", Void, [RowVector; RowVector]) ;
  add_plain ("assign_add", Void, [Vector; Real]) ;
  add_plain ("assign_add", Void, [Vector; Int]) ;
  ...
  add_plain ("assign_subtract", Void, [Matrix; Int]) ;
  add_plain ("assign_subtract", Void, [Real; Int]) ;
  add_plain ("assign_subtract", Void, [RowVector; Int]) ;
  add_plain ("assign_subtract", Void, [RowVector; RowVector]) ;
  add_plain ("assign_subtract", Void, [Vector; Real]) ;
  add_plain ("assign_subtract", Void, [Vector; Int]) ;
  ...
  add_plain ("assign_elt_divide", Void, [Matrix; Int]) ;
  add_plain ("assign_elt_divide", Void, [RowVector; Int]) ;
  add_plain ("assign_elt_divide", Void, [RowVector; RowVector]) ;
  add_plain ("assign_elt_divide", Void, [Vector; Real]) ;
  add_plain ("assign_elt_divide", Void, [Vector; Int]) ;
  ...
  add_plain ("assign_divide", Void, [Matrix; Int]) ;
  add_plain ("assign_divide", Void, [Real; Int]) ;
  add_plain ("assign_divide", Void, [RowVector; Int]) ;
  add_plain ("assign_divide", Void, [Vector; Int]) ;
