...
let message s =
  ...
  | 404 ->
      "Identifier expected after \"real\" in local (or model block) variable \
       declaration. (No transformations/constraints allowed.)\n"
  ...
  | 411 -> "Expression \";\" expected after assignment.\n"
  | 620 ->
  ...
  | 14 ->
      "(Non-void) type followed by expression expected for function argument \
       declaration.\n"
  ...
  | 21 -> "An unsized type is expected as a function return type.\n"
  ...
  | 476 -> "An expression is expected for type lower bound.\n"
  ...
  | 477 ->
      "\">\" or \", upper = expression \">\" expected after specifying lower \
       bound for type.\n"
  ...
  | 581 -> "\";\" or plain assignment expected after variable declaration.\n"
  ...
  | 536 ->
      "\"[\" expression \",\" expression \"]\"  is expected as sizes of \
       matrix type.\n"
  ...
  | 574 -> "A size is expected after a variable declaration.\n"
  | 575 -> "An expression is expected for a type size.\n"
  | 578 -> "An expression is expected for a type size.\n"
