...
let message =
  fun s ->
    ...
    | 215 ->
        "<YOUR SYNTAX ERROR MESSAGE HERE>\n"
    | 213 ->
        "Expression followed by \")\" expected after \"(\".\n"
    | 39 ->
        "Expression expected after \"[\".\n"
    | 177 ->
        "<YOUR SYNTAX ERROR MESSAGE HERE>\n"
    ...
    | 398 ->
        "Ill-formed statement. Expected statement or variable declaration or \"}\" after conditional true branch.\n"
    | 399 ->
    ...
    | 605 ->
        "Expected statement or variable declaration or \"}\".\n"
    | 609 ->
