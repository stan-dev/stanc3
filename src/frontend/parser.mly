...
%token VOID "void" INT "int" REAL "real" COMPLEX "complex" VECTOR "vector"
       ...
       ROWSTOCHASTIC "row_stochastic" COLUMNSTOCHASTIC "column_stochastic"
...
reserved_word:
  ...
  | ROWSTOCHASTIC { "row_stochastic", $loc, true }
  | COLUMNSTOCHASTIC { "column_stochastic", $loc, true }
...
top_var_type:
  ...
  | ROWSTOCHASTIC LBRACK e1=expression COMMA e2=expression RBRACK
    { grammar_logger "ROWSTOCHASTIC_top_var_type" ; (SizedType.SMatrix (AoS, e1, e2), Transformation.RowStochastic) }
  | COLUMNSTOCHASTIC LBRACK e1=expression COMMA e2=expression RBRACK
    { grammar_logger "COLUMNSTOCHASTIC_top_var_type" ; (SizedType.SMatrix (AoS, e1, e2), Transformation.ColumnStochastic) }
