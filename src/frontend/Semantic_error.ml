...
module TypeError = struct
  type t =
    ...
    | InvalidSparseMatrixDeclLocation of string
...
let invalid_sparsematrix_decl_location loc blockname = TypeError (loc, TypeError.InvalidSparseMatrixDeclLocation blockname)
