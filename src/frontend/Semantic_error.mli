...
val template_capture : Location_span.t -> string -> t
...
val invalid_forward_decl : Location_span.t -> t
val invalid_special_fn : Location_span.t -> t
val invalid_return_type : Location_span.t -> t
