...
module Fixed : sig
  ...
  val map_accum_left : f:('state -> 'a -> ('b*'state)) -> init:'state -> 'a t -> 'b t * 'state

  val map_accum_right : f:('state -> 'a -> ('b*'state)) -> init:'state -> 'a t -> 'b t * 'state
end
...
(* == Binary operations ===================================================== *)
val apply_binop : 'a -> Operator.t -> 'a Fixed.t -> 'a Fixed.t -> 'a Fixed.t option 
...
(* -- Dot product ----------------------------------------------------------- *)
val simplify_dot_product_opt  : Typed.Meta.t -> Typed.t -> Typed.t -> Typed.t option
val dot_product : Typed.Meta.t -> Typed.t -> Typed.t -> Typed.t 
(* -- Rows dot product ------------------------------------------------------ *)
val simplify_rows_dot_product_opt  : Typed.Meta.t -> Typed.t -> Typed.t ->Typed.t option
val rows_dot_product : Typed.Meta.t -> Typed.t -> Typed.t ->Typed.t 
(* -- Columns dot product --------------------------------------------------- *)
val simplify_columns_dot_product_opt : Typed.Meta.t -> Typed.t -> Typed.t ->Typed.t option
val columns_dot_product : Typed.Meta.t -> Typed.t -> Typed.t ->Typed.t 

(* == Transformations for distributions ===================================== *)
val lpdf_glm_lpdf : (Typed.t -> Typed.t -> Typed.t -> 'a) -> Typed.t -> 'a option 
val lpdf_trans_glm_lpdf : link:string -> (Typed.t -> Typed.t -> Typed.t -> 'a) -> Typed.t -> 'a option 
val lpdf_trans_lpdf : link:string -> ('a Fixed.t -> 'b) -> 'a Fixed.t -> 'b option 
val rng_trans_rng : link:string -> ('a Fixed.t -> 'b) -> 'a Fixed.t -> 'b option 

(* == Binary distributions ================================================== *)

module Bernoulli_logit_glm : sig 
  val lpmf : 'a -> 'a Fixed.t -> 'a Fixed.t -> 'a Fixed.t -> 'a Fixed.t -> 'a Fixed.t
end 
...
module Beta_binomial : sig 
  val lpmf : 'a -> 'a Fixed.t -> 'a Fixed.t -> 'a Fixed.t  -> 'a Fixed.t -> 'a Fixed.t
  val cdf : 'a -> 'a Fixed.t -> 'a Fixed.t -> 'a Fixed.t  -> 'a Fixed.t -> 'a Fixed.t
  val lcdf : 'a -> 'a Fixed.t -> 'a Fixed.t -> 'a Fixed.t-> 'a Fixed.t -> 'a Fixed.t
  val lccdf : 'a -> 'a Fixed.t -> 'a Fixed.t -> 'a Fixed.t -> 'a Fixed.t -> 'a Fixed.t
...
module Neg_binomial_2_log_glm : sig 
  val lpmf : 'a -> 'a Fixed.t -> 'a Fixed.t -> 'a Fixed.t  -> 'a Fixed.t -> 'a Fixed.t -> 'a Fixed.t  
  val rng : 'a -> 'a Fixed.t -> 'a Fixed.t -> 'a Fixed.t -> 'a Fixed.t -> 'a Fixed.t
end
...
module Normal_id_glm : sig 
  val lpdf : 'a -> 'a Fixed.t -> 'a Fixed.t -> 'a Fixed.t  -> 'a Fixed.t  -> 'a Fixed.t    -> 'a Fixed.t     
end
...
module Exp_mod_normal : sig 
  val lpdf : 'a -> 'a Fixed.t -> 'a Fixed.t  -> 'a Fixed.t  -> 'a Fixed.t    -> 'a Fixed.t       
  val cdf : 'a -> 'a Fixed.t -> 'a Fixed.t  -> 'a Fixed.t  -> 'a Fixed.t    -> 'a Fixed.t     
  val lcdf : 'a -> 'a Fixed.t -> 'a Fixed.t  -> 'a Fixed.t  -> 'a Fixed.t    -> 'a Fixed.t     
  val lccdf : 'a -> 'a Fixed.t -> 'a Fixed.t  -> 'a Fixed.t  -> 'a Fixed.t    -> 'a Fixed.t     
  val rng : 'a -> 'a Fixed.t -> 'a Fixed.t  -> 'a Fixed.t  -> 'a Fixed.t
