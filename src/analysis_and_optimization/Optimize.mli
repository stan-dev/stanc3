...
(** Rewrite a loop whose body is a single scalar density statement or
    elementwise assignment into the vectorized statement, when the Stan Math
    signatures have one. Loops that do not match are left unchanged *)
