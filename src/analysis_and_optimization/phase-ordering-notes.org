...
** B
     ...
     Run optimization: function_inlining
...
** C
     ...
     Run optimization: one_step_loop_unrolling

       \#Matthijs: expression_propagation < partial_evaluation\\
     Run optimization: expression_propagation

       \#Matthijs: partial_evaluation < lazy_code_motion\\
     Run optimization: partial_evaluation
