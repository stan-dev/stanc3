  ...
  module type S1 = sig
    ...
    val inj4 : 'a * ('a * ('a * ('a * 'a t Pattern.t) Pattern.t) Pattern.t) Pattern.t -> 'a t
    val inj5 : 'a * ('a * ('a * ('a * ('a * 'a t Pattern.t) Pattern.t) Pattern.t) Pattern.t) Pattern.t -> 'a t
  end
  ...
  module type S2 = sig 
    ...
    val inj_succ : ('c -> ('a,'b) t)  -> 'b * ('a First.t , 'c) Pattern.t -> ('a,'b) t
    val inj2 : 'b * ('a First.t , 'b * ('a First.t , ('a,'b) t) Pattern.t) Pattern.t -> ('a,'b) t
    val inj3 : 'b * ('a First.t , 'b * ('a First.t , 'b * ('a First.t , ('a,'b) t) Pattern.t) Pattern.t) Pattern.t -> ('a,'b) t
    
    val inj4 : 'b * ('a First.t , 'b * ('a First.t , 'b * ('a First.t , 'b * ('a First.t , ('a,'b) t) Pattern.t) Pattern.t) Pattern.t) Pattern.t -> ('a,'b) t
    
    val inj5 : 'b * ('a First.t , 'b * ('a First.t , 'b * ('a First.t , 'b * ('a First.t , 'b * ('a First.t , ('a,'b) t) Pattern.t) Pattern.t) Pattern.t) Pattern.t) Pattern.t -> ('a,'b) t
  end 
